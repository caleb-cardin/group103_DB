...
app.post('/add-assignment-employee-form', function (req, res) {
    ...
    db.pool.query(query1, function (error, rows, fields) {
        ...
        if (error) {
            ...
            db.pool.query(selectEmployeesHasAssignmentsQuery, function (error, rows, fields) {
...
app.delete('/delete-assignment-employee-ajax', function (req, res, next) {
    let data = req.body;
    let deleteCustomerQuery = `DELETE FROM AssignmentsHasEmployees WHERE AssignmentsHasEmployees.assignmentEmployeeID = ${data.assignmentEmployeeID};`;
...
app.post('/add-customer-order-form', function (req, res) {
    ...
    db.pool.query(query1, function (error, rows, fields) {
        ...
        if (error) {
            ...
            db.pool.query(selectOrdersHasCustomersQuery, function (error, rows, fields) {
...
app.delete('/delete-customer-order-ajax', function (req, res, next) {
    let data = req.body;
    let deleteCustomerQuery = `DELETE FROM CustomersHasOrders WHERE CustomersHasOrders.customerOrderID = ${data.customerOrderID};`;
